...
export function Button({
  ...
  return (
    <button
      type="button"
      className={`inline-flex h-9 min-h-9 items-center justify-center rounded-md px-3.5 text-[length:var(--text-meta)] leading-[var(--text-meta-lh)] font-medium transition-[color,background-color,opacity] duration-[var(--ease-out)] disabled:cursor-not-allowed ${VARIANTS[variant]} ${className}`}
