import type { Habit, Outcome, OutcomeDetail, OutcomeSignal, Task } from '@vital/dto';
...
import { habitTodayProgress, isUndoable } from './model';
  ...
  return (
    <div className="flex h-full min-h-0 bg-canvas">
      <ThreadCanvas>
        ...
        />
        <HabitsSection habits={detail.habits} />
        <TasksSection
          detail={detail}
          timeZone={timeZone}
